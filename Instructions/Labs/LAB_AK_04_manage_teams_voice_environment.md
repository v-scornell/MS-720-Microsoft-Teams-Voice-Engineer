...
4. Run the following command to create a new resource account with an Exchange Online mailbox:
    ...
    ```powershell
    New-Mailbox -MicrosoftOnlineServicesID mtr01@lab<customlabnumber>.o365ready.com -Name "mtr01" -Alias mtr01 -Room -EnableRoomMailboxAccount $true  -RoomMailboxPassword (ConvertTo-SecureString -String '<Insert the MOD Administrator password>' -AsPlainText -Force)
...
1. Sign into **MS720-CLIENT01** as “Admin” . In this task we will treat MS720-CLIENT01 as the PC of the user with the problem.
